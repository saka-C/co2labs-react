  ...
  return (
    <section className="lg:mx-28 mx-10 flex flex-col gap-16 py-24">
      ...
      <div className="lg:flex xl:gap-24 gap-5 lg:justify-between">
        <form action="" className="bg-white flex flex-col justify-center md:p-14 p-5 lg:w-1/2 gap-5 rounded-xl shadow-xl">
        ...
        <div className="lg:w-1/2">
          <iframe
            className="w-full h-96 rounded-xl lg:mt-0 mt-10"
